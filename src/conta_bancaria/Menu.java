...
public class Menu {
	...
	public static void main(String[] args) {
	 ...
	 public static void sobre() {
		...
		System.out.println("https://github.com/MiFlow8?tab=repositories");
		System.out.println("*********************************************************");
	 }
	 ...
	 private static void cadastrarConta() {
		...
		private static void criarContasTeste() {
			...
			contaController.cadastrar(
					new ContaCorrente(contaController.gerarNumero(), 123, 1, "João da Silva", 1000.00f, 100.0f));
			contaController.cadastrar(
					new ContaCorrente(contaController.gerarNumero(), 456, 1, "Maria dos Santos", 2000.00f, 200.0f));
			contaController.cadastrar(
